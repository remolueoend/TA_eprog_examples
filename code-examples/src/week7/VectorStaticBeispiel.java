...
public class VectorStaticBeispiel {
	...
	public static void main(String[] args) {
		...
		// die add() Funktion haben wir als static deklariert. Also müssen wir kein
		// Objekt erstellen um
		// diese Funktion zu nutzen.
		Vektor v3 = Vektor.add(v1, v2);

		// die norm() Funktion ist nicht als static deklariert, deshalb müssen wir diese
		// Funktion von einem
		...
		// Java weiss nicht, wie man 2 Objekte vergleicht. Java wird bei "==" versuchen
		// die Referenzen der beiden
		// Objekte zu vergleichen. Uns interessiert jedoch nur obe die Werte gleich
		// sind. Deswegen schreiben
...
class Vektor {
	...
	/*
	 * Gibt true zurück falls der Vektor, der diese Funktion aufruft dem Vektor vec
	 * gleicht.
	 */
	...
	/*
	 * Gibt einen String zurück um das Vektor Object schön auszugeben (Optional -
	 * müsst ihr noch nicht verstehen)
	 */
	...
	/*
	 * Gibt neuen Vektor zurück, der die Summe beider gegebenen Vektoren ist. Das
	 * ist eine statische Funktion, also wir brauchen kein Objekt zu erstellen um
	 * auf diese Funktion zuzugreifen. (Siehe Beispiel)
	 */
	...
	/*
	 * Gibt die Norm des Vektor Objekts zurück, dass diese Funktion aufgerufen hat.
	 * (siehe Beispiel)
	 */
	public double norm() {
