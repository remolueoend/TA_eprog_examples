package week11;
/**
 * Schreibt jeder Klasse welche dieses Interface implementiert vor, eine Methode
 * `String nextChar()` auf ihren Objekten zu implementieren.
 */
...
public class InterfaceExample {
	...
	/**
	 * Diese Methode erwartet eine Data-Source und liest von dieser die ersten
	 * Zeichen bis zu einem Leerschlag oder Zeilenumbruch. Danach gibt sie diese
	 * Zeichen als Integer interpretiert wieder zurück.
	 * 
	 * Diese Methode interessiert sich nicht, von welcher Klasse ein gegebenes
	 * dataSource-Objekt stammt. Diese Funktion erwartet nur, dass die auf dem
	 * gegebenen Objekt die Methode `String nextChar()` aufrufen kann.
	 */
	public static int readFirstInt(DataSource dataSource) {
		// dataSource.nextChar() kann hier aufgerufen werden, da wir den Typ des
		// Parameters dataSource als `DataSource` deklariert haben.
		// Das heisst, jedes gegebene dataSource-Objekt muss von einer Klasse stammen,
		// welche das `DataSource` Interface implementiert,
